...
const Image = ({ src, alt }: { src: string; alt: string }) => (
	<img src={src} alt={alt} className="w-full rounded border border-black p-1" />
)
...
export const webProjects: ProjectType[] = [
	{
		...
		visualContent: <Image src="/CGPhotography.png" alt="A Photo of caitlingrantphotography.com" />,
		links: [
			{
...
export const industrialDesignProjects: ProjectType[] = [
	...
	// 	visualContent: <Image src="/projects/" alt="" />,
	// 	links: [
	// 		{
	// 			href: "https://makerworld.com/en/models/550097",
	// 			text: "Magic Corne",
	// 			icon: "bambulab",
	// 		},
	// 	],
	// },
	{
      ...
      The honey bucket was great but didn’t really scale all that well. I was too show to keep my calibers and pliers securely nestled and was too tall to get my hands on a paper clip. 

      I designed it will hollow walls as a subconscious forced-sorting function, where only the items big enough to not fall out the sides are appropriate for that section additionally the height and relative diameter of each had the same effect for items too large for the smaller containers. 

     The hollow walls also emulated a feature I enjoyed with the honey bucket. Transparency. In addition to transparency the hollow walls force items to go into their respective homes and allowing a quick scan for an item, I feel like it has achieved it’s goal and fulfilled it’s mission`,
		createdAt: "Feb 25, 2023",
		lastUpdatedAt: "Apr 3, 2024",
		visualContent: (
			// <ThingBucketSlideshow />
			<Image alt="Image of the thing buckets model" src="/projects/thing_bucket/thing_bucket.png" />
		),
		links: [
			{
				href: "https://makerworld.com/en/models/550102",
				text: "Thing Bucket",
				icon: "bambulab",
			},
		],
